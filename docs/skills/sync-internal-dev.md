...
> 一键自动拉取内网 dev 分支最新代码并同步至 GitHub 仓库 main 分支。AI 自动在独立临时分支/worktree 中恢复 GitHub-only 配置、清洗内网私有配置，并仅 push 到 github/main。当用户说“同步内网 dev”、“同步最新内网代码”、“把内网 dev 搬到 github”时触发。
